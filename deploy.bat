...
REM CONFIGURATION
REM ─────────────────────────────────────────────────────
SET "PLUIGN_NAME=Markdown to HTML API"
SET "PLUGIN_TAGS=Markdown, Converter, HTML"
SET "HEADER_SCRIPT=C:\Ignore By Avast\0. PATHED Items\Plugins\deployscripts\myplugin_headers.php"
SET "PLUGIN_DIR=C:\Users\Nathan\Git\markdown-html-api\markdown-html-api"
IF "%PLUGIN_DIR:~-1%"=="\" SET "PLUGIN_DIR=%PLUGIN_DIR:~0,-1%"
SET "PLUGIN_FILE=%PLUGIN_DIR%\markdown-html-api.php"
SET "CHANGELOG_FILE=C:\Users\Nathan\Git\rup-changelogs\markdown-html-api.txt"
